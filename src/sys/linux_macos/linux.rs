...
pub unsafe fn fsetxattr(fd: c_int, name: *const c_char, value: *const c_void, size: size_t) -> ssize_t {
    extern "C" {
        fn fsetxattr(fd: c_int, name: *const c_char, value: *const c_void, size: size_t, flags: c_int) -> ssize_t;
    }
...
pub unsafe fn lsetxattr(path: *const c_char, name: *const c_char, value: *const c_void, size: size_t) -> ssize_t {
    extern "C" {
        fn lsetxattr(path: *const c_char, name: *const c_char, value: *const c_void, size: size_t, flags: c_int) -> ssize_t;
    }
